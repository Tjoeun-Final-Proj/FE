...
class OwnerOrderView extends StatelessWidget {
  ...
  final ShipmentUnassigedController shipmentUnassigedController = Get.put(
    ShipmentUnassigedController(),
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: Obx(() {
          // 3. 로딩 상태 처리
          if (shipmentUnassigedController.isLoading.value &&
              shipmentUnassigedController.unassignedShipments.isEmpty) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final item =
                  shipmentUnassigedController.unassignedShipments[index];
  ...
  Widget _buildOrderItem(ShipmentUnassignedResponseModel item) {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        ...
        // 🎯 3. 돌아오는 시점에 목록 새로고침
        shipmentUnassigedController.refreshList();
      },
      child: Container(
