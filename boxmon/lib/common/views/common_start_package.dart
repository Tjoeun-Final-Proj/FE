                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: TextStyle(
                                color: viewModel.startFullAddress.value.isEmpty
                                    ? Colors.grey
                                    : Colors.black,
                                fontSize: 16,
                                fontWeight:
                                    viewModel.startFullAddress.value.isNotEmpty
                                    ? FontWeight.bold
                                    : FontWeight.normal,
                              ),
                    ...
                    return Column(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => viewModel.startAddressSetup(
                            idx == 0
                                ? AddressType.stopover1
                                : AddressType.stopover2,
                            pageController,
                          ),
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Text(
                              // 🔥 데이터 바인딩
                              viewModel.endFullAddress.value.isEmpty
                                  ? "도착지"
                                  : viewModel.endFullAddress.value,
                              style: TextStyle(
                                color: viewModel.endFullAddress.value.isEmpty
                                    ? Colors.grey
                                    : Colors.black,
                                fontSize: 16,
                              ),
      ...
      () => Stack(
        children: [
          ...
          NaverMap(
            ...
            onSymbolTapped: (symbol) => viewModel.handleMapTap(
              symbol.position,
